            ...
            <form action="{{ route('admin.nutrition-plans.update', $nutritionPlan->id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="md:col-span-2">
                        <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Comentarios
                            Adicionales</label>
                ...
                <div class="border-t border-gray-100 pt-8 mb-8">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div>
                            ...
                            <select id="calc_gender" name="gender"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="number" id="calc_weight" name="weight" step="0.1"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Altura (cm)</label>
                            <input type="number" id="calc_height" name="height"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select id="calc_activity" name="activity_level"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <option value="1.2">(1.2) Sedentario</option>
                                <option value="1.375">(1.375) Actividad Ligera</option>
                                <option value="1.55">(1.55) Actividad Moderada</option>
                                <option value="1.725">(1.725) Actividad Intensa</option>
                                <option value="1.9">(1.9) Atleta Profesional</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Fórmula</label>
                            <select id="calc_formula" name="formula"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <option value="mifflin">Mifflin-St Jeor</option>
                                <option value="harris">Harris-Benedict</option>
                                <option value="tinsley">Tinsley (Deportistas)</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Objetivo</label>
                            <select id="calc_objective" name="objective"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Ajuste Calórico (kcal)</label>
                            <input type="number" id="calc_adjustment" name="caloric_adjustment" value="0"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>

                    <div class="mt-6 flex justify-end">
                        <button type="button" id="btn_calculate"
                            class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-6 rounded-lg transition-colors flex items-center gap-2">
                ...
                <div
                    class="border-t border-gray-100 pt-8 mb-6 bg-gray-50 -mx-8 px-8 pb-8 rounded-b-xl border-b border-l border-r">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 text-center">
                            ...
                            <p class="text-3xl font-bold text-gray-900 mb-4"><span id="display_tdee">0</span> <span
                                    class="text-sm text-gray-500">kcal</span></p>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <input type="number" id="calc_protein_kg" value="2.2" step="0.1"
                                        class="w-24 text-center rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                </div>
                                <div class="flex items-center justify-between">
                                    <label class="text-sm font-medium text-gray-700">Lípidos (g/kg)</label>
                                    <input type="number" id="calc_lipids_kg" value="0.8" step="0.1"
                                        class="w-24 text-center rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                </div>
                                <div class="flex items-center justify-between">
                                    <label class="text-sm font-medium text-gray-500">Carbohidratos (g/kg)</label>
                                    <input type="number" id="display_carbs_kg" value="0.0" disabled
                                        class="w-24 text-center rounded-md border-gray-200 bg-gray-50 text-gray-500">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-100 pt-8 mt-8 mb-6 relative">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button type="button" id="btn_add_meal"
                                class="flex items-center gap-2 text-blue-600 hover:text-blue-800 font-medium bg-blue-50 px-4 py-2 rounded-lg border border-blue-100 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden m-4">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="modal_food_name" placeholder="Ej. Pechuga de pollo cocida"
                ...
                <div class="border-t border-gray-100 pt-4 mt-2 hidden">
                    <p class="text-sm font-semibold text-gray-600 mb-3">Valores Nutricionales (Para la cantidad ingresada)
                    </p>
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div>
                            <label class="block text-xs text-gray-500 mb-1">Calorías</label>
                            <input type="number" id="modal_food_cals" value="0"
                        ...
                        <div>
                            ...
                            <input type="number" id="modal_food_prot" step="0.1" value="0"
                                class="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-xs text-orange-500 mb-1">Carbs (g)</label>
                            <input type="number" id="modal_food_carbs" step="0.1" value="0"
                                class="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        <div>
                            <label class="block text-xs text-green-500 mb-1">Grasa (g)</label>
                            <input type="number" id="modal_food_fat" step="0.1" value="0"
                                class="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 flex justify-end">
                    <button type="button" id="btn_save_food"
                        class="bg-blue-600 text-white px-5 py-2.5 rounded-lg font-bold hover:bg-blue-700 transition-colors shadow-sm">
                        Añadir Alimento
                    </button>
                </div>
            </div>
