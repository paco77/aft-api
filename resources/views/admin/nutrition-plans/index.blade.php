                ...
                @foreach ($plans as $plan)
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right space-x-2">
                            ...
                            <a href="{{ route('admin.nutrition-plans.edit', $plan) }}" class="inline-flex items-center px-3 py-1.5 bg-blue-50 text-blue-700 hover:bg-blue-100 hover:text-blue-900 rounded-md text-sm font-medium transition-colors" title="Editar Plan">
