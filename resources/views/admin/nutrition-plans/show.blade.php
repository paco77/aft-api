        ...
        <div class="px-8 pb-8">
            <div class="flex justify-between items-end -mt-12 mb-6">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('admin.nutrition-plans.edit', $nutritionPlan) }}" class="text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-sm px-4 py-2 flex items-center transition-colors">
